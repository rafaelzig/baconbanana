		...
		try
		{
			try
			{
				...
				System.out.println("ID GENERATED:"
						+ controller.insertInto(TABLE_NAME, "'Rafael'",
								"'Student'"));
				...
				System.out
						.println("ID GENERATED:"
								+ controller.insertInto(TABLE_NAME,
										new String[] { "Name", "Occupation" },
										"'Joshua'", "'Artist'"));
				...
				System.out.println("ID GENERATED:"
						+ controller.insertInto(TABLE_NAME, "'Bob'",
								"'Builder'"));

				System.out
						.println("ID GENERATED:"
								+ controller.insertInto(TABLE_NAME, "'Wally'",
										"'Spy'"));

				System.out.println("ID GENERATED:"
						+ controller.insertInto(TABLE_NAME, "'Smith'",
								"'Agent'"));

				System.out.println("Selecting all tuples in table "
						+ TABLE_NAME);
				DBController.printResult(controller.selectAll(TABLE_NAME));
				...
				DBController.printResult(controller.select(TABLE_NAME, 0,
						false, "Name"));
				...
				DBController
						.printResult(controller.select(TABLE_NAME,
								"Occupation='Student'", 0, false, "Name",
								"Occupation"));
